...
namespace CodeSharp.EventSourcing
{
    ...
    public class DomainHandlerAttribute : Attribute
    {
        private IList<Path> _paths = new List<Path>();
        private const string Seperator = ":";
        private static IAggregateRootTypeProvider _aggregateRootTypeProvider = DependencyResolver.Resolve<IAggregateRootTypeProvider>();
        ...
        /// [AggregateRootEventHandler("ForumId")]
        ...
        /// [AggregateRootEventHandler("Thread:ThreadId", "Forum:ForumId")]
        ...
        /// 那在Path中就应该这样写："Orders.Account:AccountId"，或"MoneyTransfer.Account:AccountId"
        /// </param>
        public DomainHandlerAttribute(params string[] paths)
        {
            ParsePaths(paths);
        }
        ...
        {
            var matchedTypes = _aggregateRootTypeProvider.GetAllAggregateRootTypes().Where(x => x.FullName.EndsWith(className));
