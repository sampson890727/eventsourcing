...
namespace CodeSharp.EventSourcing
{
    ...
    {
        private static readonly ILogger _logger = DependencyResolver.Resolve<ILoggerFactory>().Create("EventSourcing.MsmqUtilities");
        ...
        public static void CreateQueue(string queueName, string account)
        {
            ...
            _logger.Debug("Queue created: " + queueName);
        }
        ...
        /// <summary>
        /// Converts a Message to an Msmq message.
        /// Doesn't set the ResponseQueue of the result.
        /// </summary>
        /// <param name="message"></param>
        /// <returns></returns>
        public static System.Messaging.Message Convert(Message message)
        {
    ...
    /// <summary>
    /// Represents the structure of header information passed in a Message.
    /// </summary>
    [Serializable]
